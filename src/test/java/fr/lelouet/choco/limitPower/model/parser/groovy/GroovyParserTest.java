...
public class GroovyParserTest {
	...
	public void simpleTest() {
		...
		Assert.assertEquals(m.getWPowerModes("w0"), Arrays.asList(new PowerMode(2, 3), new PowerMode(6, 8)));
		...
		Assert.assertEquals(m.limit(2), 3);
		Assert.assertEquals(m.limit(4), 1);
	}
